  ...
  <v-row align="center" justify="center">
    <v-col class="text-center">
      <h1 :class="`
            ...
            text-md-h3
            ${themeColorText}
          `" id="nav-projects">Personal Projects</h1>
    </v-col>
  </v-row>
  <v-lazy :value="ppC" @input="setPpC" :options="{
        rootMargin: '80%',
        threshold: 1,
      }" min-height="100vh" transition="scroll-y-transition" v-intersect="onPPIntersect">
    <v-container>
      <v-row class="mx-4" justify="center">
        <v-col cols="10" md="8" class="elevation-15 pa-4">
          ...
          `">
            Journal Website
            (
            <a href="https://tenzinandhobbes.web.app" target="_blank">https://tenzinandhobbes.web.app</a>)
          </h4>
          <ul class="text-body-2 text-md-body-1 mx-4">
            ...
            <li>
              ...
              <a href="https://stackoverflow.com/questions/63455143/how-to-resolve-rangeerror-maximum-call-stack-size-exceeded-via-firebase-signi" target="_blank">Stack Overflow</a>
              question page.
            </li>
            <li>
